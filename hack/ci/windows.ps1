...
Try {
    ...
    # PR
    if (-not ($null -eq $env:PR)) { Write-Output "INFO: PR#$env:PR (https://github.com/demonoid81/moby/pull/$env:PR)" }
    ...
    # After https://github.com/demonoid81/moby/pull/30290, .git was added to .dockerignore. Therefore
